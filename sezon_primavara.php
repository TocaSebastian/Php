...
echo "<br><h2> <center>Articole specifice anotimpului primavara.</center></h2>";

$sql = "SELECT * FROM articol, images WHERE anotimp='primavara' AND articol.cod_art = images.cod_art";
