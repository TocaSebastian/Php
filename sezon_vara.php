...
//echo "Sesiune id:",$id_sesiune,"[".strlen($id_sesiune)."]";
//echo "<br>User:",$_SESSION["user_id"];
include 'user_meniu.php';
include 'connect.php';
echo '<a name="top_page"></a>';

echo "<br><h2> <center><strong>Articole specifice anotimpului vara.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE anotimp='vara' AND articol.cod_art = images.cod_art";
