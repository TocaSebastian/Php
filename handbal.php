...
echo "<br><h2> <center><strong>Articole de handbal.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE utilitate='handbal' AND articol.cod_art = images.cod_art";
