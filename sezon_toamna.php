...
echo "<br><h2> <center>Articole specifice anotimpului toamna.</center></h2>";

$sql = "SELECT * FROM articol, images WHERE anotimp='toamna' AND articol.cod_art = images.cod_art";
