...
echo "<br><h2> <center><strong>Articole pentru drumetie.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE utilitate='drumetie' AND articol.cod_art = images.cod_art";
