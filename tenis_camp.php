...
echo "<br><h2> <center><strong>Articole pentru tenis de camp.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE utilitate='tenis de camp' AND articol.cod_art = images.cod_art";
