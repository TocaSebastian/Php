...
echo "<br><h2> <center><strong>Articole de baschet.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE utilitate='baschet' AND articol.cod_art = images.cod_art";
