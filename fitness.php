...
echo "<br><h2> <center><strong>Articole de fitness.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE tip_echipament='fitness' AND articol.cod_art = images.cod_art";
