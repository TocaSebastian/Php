...
$a=["plic_albastru.jpg", "plic_lila.jpg","plic_maro.jpg","plic_negru.jpeg", "plic_rosu.jpg", "plic.jpg"];
/////////////////////////////////////////////////////////////////////////////////////////////////
...
<form method="post">
<br><br>
<table border="3" width="600" height="380">
	<tr>
	...
	<tr>
		...
		<td height="27" width="97" align="center" rowspan="3">
			<img src="plicuri/<?php echo $a[rand(0,5)];?>" height="60" width="80">
		</td>
	<tr>
	...
	<tr>
		...
		<td height="27" width="540">&nbsp;Administrator</td>
		<!--td height="27" width="97" align="center"-->
		</td>
	</tr>
	<tr>
