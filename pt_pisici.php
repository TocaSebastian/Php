...
echo "<br><p> <center><h2>Afisare Brand-uri crescator pentru pisici.</h2></center>";

$sql = "SELECT * FROM articol, images WHERE tip_animal='pisica' AND articol.cod_art = images.cod_art ORDER BY brand";
