...
echo "<br><p> <center><h2>Recompensa pentru pisici.</h2></center>";

$sql = "SELECT * FROM articol, images WHERE utilitate='recompensa' AND tip_animal='pisica' AND articol.cod_art = images.cod_art";
