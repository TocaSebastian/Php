...
echo "<br><h2> <center><strong>Articole specifice sporturilor in sala.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE anotimp='sala' AND articol.cod_art = images.cod_art";
