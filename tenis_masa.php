...
echo "<br><h2> <center><strong>Articole pentru tenis de masa.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE utilitate='tenis de masa' AND articol.cod_art = images.cod_art";
