...
echo "<br><p> <center><h2>Hrana uscata pentru pisici.</h2></center>";

$sql = "SELECT * FROM articol, images WHERE utilitate='uscata' AND tip_animal='pisica' AND articol.cod_art = images.cod_art";
