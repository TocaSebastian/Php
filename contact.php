...
echo "<br><h2> <center><strong>Articole specifice sporturilor de contact.</strong></center></h2><br>";

$sql = "SELECT * FROM articol, images WHERE tip_echipament='contact' AND articol.cod_art = images.cod_art";
