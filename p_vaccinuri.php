...
echo "<br><p> <center><h2>Vaccinuri pentru pisici</h2></center>";

$sql = "SELECT * FROM articol, images WHERE utilitate='vaccin' AND tip_animal='pisica' AND articol.cod_art = images.cod_art";
