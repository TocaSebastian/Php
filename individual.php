...
echo "<br><h2> <center><strong>Articole specifice sporturilor individuale.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE tip_echipament='individual' AND articol.cod_art = images.cod_art";
