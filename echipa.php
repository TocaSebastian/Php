...
echo "<br><h2> <center><strong>Articole specifice sporturilor de echipa.</strong></center></h2>";

$sql = "SELECT * FROM articol, images WHERE tip_echipament='echipa' AND articol.cod_art = images.cod_art";
