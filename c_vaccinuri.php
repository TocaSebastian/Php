...
echo "<br><p> <center><h2>Vaccinuri pentru caini</h2></center>";

$sql = "SELECT * FROM articol, images WHERE utilitate='vaccin' AND tip_animal='caine' AND articol.cod_art = images.cod_art";
